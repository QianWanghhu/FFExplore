...
for n in range(nstart, nstop, nstep):
    ...
    for x_default in defaults_list:
        error_dict[f'sample_{n}'], pool_res = group_fix(partial_order[partial_key], evaluate, 
